...
if("TRUE" STREQUAL "TRUE")
  set(lattice_planner_SOURCE_PREFIX /home/max/navi_ws/src/lattice_planner)
  set(lattice_planner_DEVEL_PREFIX /home/max/navi_ws/devel)
  ...
  set(lattice_planner_INSTALL_PREFIX /home/max/navi_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/max/navi_ws/src/lattice_planner/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;std_msgs;geometry_msgs;tf;tf2;tf2_ros;agv_control_msgs")
